	...
	if (
		...
		document.querySelectorAll(".js-media-list").forEach((elem, index) => {
			let slider = new Swiper(elem, {
				slidesPerView: elem.closest('.product__outer').classList.contains("product__outer--full-screen") ||
				...
				elem.closest('.product__outer').classList.contains("product__outer--thumbs-aside")
					? 1
					: 1.1,
				spaceBetween: elem.closest('.product__outer').classList.contains("product__outer--multiple-top")
					? 0
					: 1,
				autoHeight: true,
				speed: 500,
				freeMode: {
					enabled: !!elem.closest('.product__outer').classList.contains("product__outer--multiple-top"),
					sticky: true,
				},
				navigation: {
					...
					const initSlider = () => {
						document.querySelectorAll(".js-recommendation-swiper").forEach((elem, index) => {
							...
							let slider = new Swiper(elem, {
								...
								speed: 1000,
								navigation: {
									nextEl: elem.querySelector(".product-recommendations__slider-nav .swiper-button-next"),
									prevEl: elem.querySelector(".product-recommendations__slider-nav .swiper-button-prev"),
								},
								breakpoints: {
									576: {
										slidesPerView: 2,
